  ...
  return (
    <>
      ...
      <div id="invoice-preview" style={{ margin: "20px 30px" }}>
        ...
        <p className="smalltext">{invoice.format?.heading}</p>

        <div className="marginxdiv"></div>

        <table className="table" style={{ width: 510 }}>
          <tr style={{ textAlign: "left" }}>
            <th className="contrast tdleft">{user?.company.legal_name}</th>
          ...
          <tr>
            <td className="tdleft">
              N° SIRET : {user?.company?.registration_number}
            </td>
            <td>
        ...
        <table className="table" style={{ width: "510px" }}>
          <tr>
            <td className="whitened tdleft" style={{ fontWeight: "800" }}>
              Date d'émission
            </td>
            <td>
              {(invoice.emit_date &&
        ...
        >
          ...
          <tbody>
            {(invoice.content ?? []).map((line, index) => {
              ...
              if (line.discount && line.discount?.mode && line.unit_price) {
                unitPrice =
                    ...
                    <>
                      <td style={{ textAlign: "left" }}>
                        <div
                          className="margindiv"
                          style={{
                            height: _.isEmpty(line.description) ? 1 : 20,
                          }}
                        ></div>
                        <p>{line.name}</p>
                        {line.description && (
                      ...
                      <td>{line.tva + " %"}</td>
                      <td>{formatAmount(linePrice)}</td>
                      <td>{formatAmount(linePriceWithTaxes)}</td>
                    </>
                  )}
                </tr>
              );
        ...
        <div style={{ width: "510px", position: "relative" }}>
          ...
          >
            <tbody>
              ...
              {invoice.discount && invoice.discount.mode && (
                <tr>
                  <td style={{ verticalAlign: "middle" }}>
                    <div className="margindiv_small"></div>
                    Remise
                  ...
                  <td style={{ textAlign: "end" }}>
                    {invoice.discount?.mode === "amount"
                      ? formatAmount(
                          typeof invoice.discount.value === "string"
                            ? parseInt(invoice.discount.value)
        ...
        <div className="margindiv" style={{ clear: "left" }}></div>
        <div style={{ width: 510, clear: "left" }}>
          <p className="smalltext">{invoice.format?.footer}</p>
          <p className="smalltext">{invoice.format?.payment_terms}</p>
          <p className="smalltext">{invoice.format?.tva}</p>
        </div>
      </div>
    </>
  );
