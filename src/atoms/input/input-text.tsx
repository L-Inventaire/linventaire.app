...
export const defaultInputClassName = (theme: "plain" = "plain") => {
  return "shadow-sm focus:ring-wood-500 focus:border-wood-500 block w-full text-sm border-gray-200 dark:bg-wood-990 dark:border-wood-900 dark:text-white rounded-md";
};
