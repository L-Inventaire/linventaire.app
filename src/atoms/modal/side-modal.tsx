        ...
        >
          ...
          >
            ...
            >
              <Dialog.Panel
                className={
                  "text-black dark:text-white align-bottom bg-white dark:bg-slate-900 px-4 pt-5 pb-4 text-left w-full sm:w-auto shadow-xl transform transition-all sm:align-middle sm:p-6 " +
